...
PROJECT_REPO := github.com/hubelia/$(PROJECT_NAME)
...
GO_LDFLAGS += -X github.com/hubelia/wp-helmcharts/packages/wordpress-operator/pkg/pkg/version.buildDate=$(BUILD_DATE) \
	       -X github.com/hubelia/wp-helmcharts/packages/wordpress-operator/pkg/pkg/version.gitVersion=$(VERSION) \
	       -X github.com/hubelia/wp-helmcharts/packages/wordpress-operator/pkg/pkg/version.gitCommit=$(GIT_COMMIT) \
	       -X github.com/hubelia/wp-helmcharts/packages/wordpress-operator/pkg/pkg/version.gitTreeState=$(GIT_TREE_STATE)
